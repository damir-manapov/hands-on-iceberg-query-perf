  ...
  return [
    {
      ...
      filters: [
        ...
        // { whereClause: "WHERE created_at >= DATE '2024-06-01'", description: "date >= 2024-06-01" },
        // { whereClause: "WHERE status = 'paid' AND country = 'US'", description: "status='paid' AND country='US'" },
        // { whereClause: "WHERE age BETWEEN 25 AND 45", description: "age BETWEEN 25 AND 45" },
        // { whereClause: "WHERE contains(tags, 'alpha')", description: "tags contains 'alpha'" },
    ...
    },
    {
      ...
      filters: [
        ...
        // { whereClause: "WHERE row_28 = 'value1'", description: "row_28 = 'value1'" },
        // { whereClause: "WHERE row_48 = 'enum1'", description: "row_48 = 'enum1'" },
        // { whereClause: "WHERE row_10 > 2000", description: "row_10 > 2000" },
        // { whereClause: "WHERE row_1 >= TIMESTAMP '2024-06-01 00:00:00'", description: "row_1 >= 2024-06-01" },
        // { whereClause: "WHERE row_28 = 'value1' AND row_48 = 'enum1'", description: "row_28='value1' AND row_48='enum1'" },
        // { whereClause: "WHERE row_9 BETWEEN 2000 AND 8000", description: "row_9 BETWEEN 2000 AND 8000" },
        // { whereClause: "WHERE row_54 = 'tag1'", description: "row_54 = 'tag1'" },
        // { whereClause: "WHERE row_29 IS NOT NULL", description: "row_29 IS NOT NULL" },
      ],
      aggregationColumns: [
