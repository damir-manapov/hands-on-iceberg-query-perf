...
const paginationTableConfig: TableQueryConfig[] = [
  {
    ...
    filters: [
      ...
      { whereClause: "age > 30" },
      { whereClause: "created_at >= DATE '2024-10-01'" },
  ...
  },
  {
    ...
    filters: [
      ...
      { whereClause: "row_28 = 'c'" },
      { whereClause: "row_10 > 2000" },
      { whereClause: "row_1 >= TIMESTAMP '2024-06-01 00:00:00'" },
      { whereClause: "created_at >= TIMESTAMP '2024-10-01 00:00:00'" },
      { whereClause: "row_10 > 2000 AND row_28 = 'c'" },
...
const paginationOnTailTableConfig: TableQueryConfig[] = [
  {
    type: "singleTable",
    tableBase: "narrow",
    filters: [
      { whereClause: "", description: "no filters" },
      { whereClause: "status = 'paid' AND created_at >= DATE '2024-10-01'" },
      { whereClause: "country = 'US' AND created_at >= DATE '2024-10-01'" },
      { whereClause: "age > 30 AND created_at >= DATE '2024-10-01'" },
      { whereClause: "created_at >= DATE '2024-10-01'" },
      { whereClause: "amount > 1000 AND created_at >= DATE '2024-10-01'" },
...
export function createQuerySets(): QuerySet[] {
  return [
    ...
    {
      name: "paginationAtTailNoContention",
      // enabled: false,
      enabled: true,
      iterations: 3,
      concurrencySimulationStreams: 0,
      connectionId: "single-node",
      tableConfigs: paginationOnTailTableConfig,
    },
    {
